...
knitr::kable(head(indicators.computed %>%
                    select(pop, rbm2.2_est, rbm2.2_est_low )), format = 'html')
...
knitr::kable(head(indicators %>%
                    select(pop, ind, est ),6), format = 'html')
